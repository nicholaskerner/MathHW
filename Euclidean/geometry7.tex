...
Therefore we know that the limiting parallel ray going the direction opposite r must intersect r when extended into the full line. Call the point $\overleftrightarrow{RV}$ intersects r, S. Call the foot from S to l, T. %By exercise 7 we know that $\overrightarrow{SR}$ is limiting parallel to l.  Also by proposition 6.6 we know that $\angle TSR$ and $\angle QRV$ are both acute.  So we know that $\angle QRS$ is obtuse.  
